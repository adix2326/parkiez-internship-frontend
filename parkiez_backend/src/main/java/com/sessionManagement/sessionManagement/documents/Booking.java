...
public class Booking
{
    ...
    public Booking(String parkingId, String paymentType, LocalDateTime inTime, LocalDateTime outTime, String vehicleNo, String phoneNo, String transactionId, String attendantPhoneNo,String vehicleType) {
